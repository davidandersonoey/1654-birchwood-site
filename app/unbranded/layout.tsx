...
export const metadata: Metadata = {
  ...
  description:
    "A custom 7,000+ sq ft residence in Lorne Park, Mississauga — 5+1 beds, 5+1 baths, soundproof theatre, wine cantina, Control4 throughout.",
  alternates: { canonical: `${SITE_URL}/unbranded` },
  openGraph: {
    title: "1654 Birchwood Drive · Lorne Park, Mississauga",
    description:
      "A custom 7,000+ sq ft contemporary zen residence in Lorne Park. 5+1 beds, 5+1 baths.",
  ...
  twitter: {
    ...
    title: "1654 Birchwood Drive · Lorne Park, Mississauga",
    description: "5+1 beds, 5+1 baths, 7,000+ sq ft in Lorne Park.",
    images: ["/og-image.jpg"],
  },
